...
// set up controller to manage project metadata. 
coonDataApp.controller('metadataCtrl', function ($scope, $http) {
	console.log("Hey dain");
	...
	$http({
		method: 'POST',
		url: "DRB_PHP_FILES/getProjectMetaData.php",
		headers: {'Content-Type': 'application/x-www-form-urlencoded'}
	}).then(function success(response){
		console.log()
		$scope.project.metadata.projectTitle = response.data.projectName;
		$scope.project.metadata.projectDescription = response.data.projectDescription;
	});
});
...
coonDataApp.controller('branchCtrl', function($scope, $http) {
	...
	$http({
	    ...
	    console.log("queryBranchesFromProjects.php");
	...
	$http({
		...
		{
		    // drb edit
		    console.log("queryMolecules.php");
		    console.log(response.data);
			...
			$http({
			    ...
			    console.log("queryMoleculeMetadata.php. First iteration.");
				...
				$http({
					...
					headers: {'Content-Type': 'application/x-www-form-urlencoded'}
						...
						console.log("queryMoleculeMetadata.php. Last iteration.");
						console.log(response2.data);
						angular.forEach(response2.data, function(d)
						{
							moleculeDict[d.unique_identifier_id].metadata.push({name: d.feature_metadata_name, text: d.feature_metadata_text});
		...
		console.log("Molecule Dictionary");
			console.log(moleculeDict);
		}
	});
