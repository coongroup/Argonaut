...
if(!$row)
{
	$query="INSERT INTO project_data_visualizations (project_id, visualization_id, visualization_on) VALUES (:project_id, 'outlier', 0),(:project_id, 'volcano', 0),(:project_id, 'bar', 0),(:project_id, 'scatter', 0),(:project_id, 'pcacond', 0),(:project_id, 'pcarep', 0),(:project_id, 'go', 0)";
	$query_params = array(':project_id'=> $projectID);
	$stmt = $db->prepare($query);
	$result = $stmt->execute($query_params);
