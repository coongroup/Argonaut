   ...
   <div class="hero-box hero-box-smaller poly-bg-1 font-inverse" data-top-bottom="background-position: 50% 0px;" data-bottom-top="background-position: 50% -600px;">
      <div class="container">
         <div ng-controller="metadataCtrl">
            <h1 class="hero-heading wow fadeInDown" data-wow-duration="0.6s">{{project.metadata.projectTitle}}</h1>
            <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s" style="opacity:1">{{project.metadata.projectDescription}}</p>
         </div>
      </div>
