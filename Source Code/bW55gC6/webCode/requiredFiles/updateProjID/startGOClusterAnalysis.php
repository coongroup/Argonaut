...
//curl_setopt($ch, CURLOPT_URL,  "https://coonlabdatadev.com/DV/" . $projectID . "/calculateGOClusterEnrichments.php");
curl_setopt($ch, CURLOPT_URL,  "127.0.0.1/projects/" . $projectID . "/calculateGOClusterEnrichments.php");
