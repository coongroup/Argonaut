...
$query_params = array(':project_id' => $projectID, ':uploader_user_id' => $_SESSION['user'], ':original_file_name' => $og_file_name, ':file_name' => $file_name, ':delimiter' => $delimiter,
	...
	':quant' => $quant, ':filter' => $filter, ':branch_id' => $branch_id, ':set_name' => $set_name, ':organism_id' =>$organism_id, ':standard_id_column' => $standard_id_column, ':standard_id_type' => $standard_id_type);
...
if(!$row)
{
	...
	//curl_setopt($ch, CURLOPT_URL, "https://coonlabdatadev.com/DV/" . $projectID . "/advancedProcess.php");
	curl_setopt($ch, CURLOPT_URL, "127.0.0.1/projects/" . $projectID . "/advancedProcess.php");
