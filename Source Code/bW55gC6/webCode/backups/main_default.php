...
<!--
  ...
  <body ng-app="coonDataApp" id="app">
       ...
       <div ng-controller="editCtrl">
         <div class="container" style="margin:0px; min-width: 100%; max-width: 100%; width:100%">
            ...
            <div class="right-header-btn">
               ...
               <div class="right-header-btn">
               <div class="right-header-btn">
                  <a href="dashboard.php" class="button" title="" data-placement="bottom" data-id="#popover-search" data-original-title="Search" ng-show="canEdit">
                  <i class="glyph-icon icon-edit" style="font-size: 125%; line-height:100%"> Edit Project</i>
                  </a>
               </div>
            </div>
            <!-- .header-logo -->
   ...
   <div id="page-content" class="col-md-10 center-margin frontend-components mrg25T">
      ...
      <br>
         <div class="col-xs-9">
            <select class="form-control" name="fileSelect" ng-model="dataset" required="required" ng-options="v as v.display for v in file_list track by v.branch">
