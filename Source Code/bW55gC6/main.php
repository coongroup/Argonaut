...
<![endif]-->
<title> MS-Portal Data Viewer </title>
...
<body ng-app="coonDataApp" id="app">
   ...
   <div class="hero-box hero-box-smaller poly-bg-1 font-inverse" data-top-bottom="background-position: 50% 0px;" data-bottom-top="background-position: 50% -600px;">
      <div class="container">
         <h1 class="hero-heading wow fadeInDown" data-wow-duration="0.6s">MS-Portal Data Viewer</h1>
         <p class="hero-text wow bounceInUp" data-wow-duration="0.9s" data-wow-delay="0.2s" style="opacity:1">Please enter a project description!</p>
      </div>
...
<li class>
	<a href="#pcaConditionTab" data-toggle="tab" ng-click="pcaCondTabClick()">PCA–Conditions</a>
</li>
<li class>
	<a href="#pcaReplicateTab" data-toggle="tab" ng-click="pcaRepTabClick()">PCA–Replicates</a>
</li>
<li class>
	<a href="#goTab" data-toggle="tab" ng-click="goTabClick()">Gene Ontology</a>
</li>
</ul>
</div>
</div>
