...
<head>
  ...
  <title> H3K proteomics data–Overview </title>
      ...
      <div id="page-content-wrapper">
        <div id="page-content">
          ...
          <div class="container">
            ...
            <div id="page-title">
              <h2>{{projectName}} – Project Overview</h2>
          ...
          <div class="row" style="padding-bottom:1%">
            <div class="col-md-3">
               <div class="tile-box bg-white" style="border-color:#dfe8f1">
                  ...
                  <div class="tl-item float-right">
                    ...
                    <div class="popover right">
                      ...
                      <div class="popover-content">
                        <div class="tl-label bs-label" ng-class="event.label">{{event.activity}}</div>
