<?php
$subject = "Invitation to 'Y3K' Data Visualization Portal";
$message = "";
    ...
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="line-height:40px;font-size:1px">&nbsp;</div>
        ...
        <div style="font-size: 12px;font-style: normal;font-weight: normal;" align="center">
          <img style="border: 0;display: block;height: auto;width: 100%;max-width: 83px;" alt="" width="83" src="coonlabdatadev.com/CLDO_Logo-034.png" />
        </div>
      
              <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 20px;">
      <p class="size-48" style="Margin-top: 0;Margin-bottom: 20px;font-family: oswald,avenir next condensed,arial narrow,ms ui gothic,sans-serif;font-size: 36px;line-height: 43px;text-align: center;" lang="x-size-48"><span class="font-oswald"><font color="#ffffff">Invitation to Explore \'Y3K\' at Coon Lab Data Online&nbsp;</font></span></p>
    </div>
...
<p class="size-20" style="Margin-top: 0;Margin-bottom: 0;font-family: avenir,sans-serif;font-size: 20px;line-height: 26px;text-align: center;" lang="x-size-18"><span class="font-avenir"><span style="color:#000000"><strong>Hey There!</strong></span></span></p><p class="size-20" style="Margin-top: 20px;Margin-bottom: 0;font-family: avenir,sans-serif;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-20"><span class="font-avenir"><span style="color:#000000">This is an invitation from Nick Kwiecien to explore a brand new data visualization portal for the project \'Y3K\' at Coon Lab Data Online. Nick has designed&nbsp;a custom web portal around the \'Y3K\' dataset filled with interactive charts, graphs, and tables to help you analyze your data as fast as possible. All you have to do now is logon to Coon Lab Data Online, enter the code below, and you are ready to go!</span></span></p><p class="size-18" style="Margin-top: 30px;Margin-bottom: 0;font-family: avenir,sans-serif;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-18"><span class="font-avenir"><span style="color:#000000"><strong>Project Invitation Code:</strong> aaaaaaaaaaaaaaaaaaaa</span></span></p><p class="size-18" style="Margin-top: 30px;Margin-bottom: 0;font-family: avenir,sans-serif;font-size: 17px;line-height: 26px;text-align: left;" lang="x-size-18"><span class="font-avenir"><span style="color:#000000">Here is a message from Nick:</span></span></p><p class="size-20" style="Margin-top: 20px;Margin-bottom: 20px;font-family: avenir,sans-serif;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-20"><span class="font-avenir"><em><font color="#000000">TESTMESSAGE</font></em></span></p>
    </div>
        
            <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 36px;">
      <div class="btn btn--shadow btn--large" style="text-align:center;">
        <![if !mso]><a style="border-radius: 4px;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px 13px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;box-shadow: inset 0 -2px 0 0 rgba(0, 0, 0, 0.2);background-color: #18527c;font-family: Avenir, sans-serif;" href="http://coonlabdatadev.com">Take Me to Coon Lab Data Online!</a><![endif]>
      <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="http://coonlabdatadev.com" style="width:282px" arcsize="9%" fillcolor="#18527C" stroke="f"><v:shadow on="t" color="#134263" offset="0,2px"></v:shadow><v:textbox style="mso-fit-shape-to-text:t" inset="0px,11px,0px,10px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Avenir,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Take Me to Coon Lab Data Online!</center></v:textbox></v:roundrect><![endif]--></div>
    </div>
