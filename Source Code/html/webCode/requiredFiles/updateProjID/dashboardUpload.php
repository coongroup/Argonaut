...
<head>
	...
	<title> PROJECTNAMEHERE–Upload Data </title>
				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-body" id="uploadPanelBody">
							...
							<div class="col-xs-4">
								<label class=" control-label" style="padding-right:1%">Select Identifier Type</label><span class="glyph-icon tooltip-button icon-question-circle" style="text-align:right; color:bg-gradient-8;width: 60px" data-placement="right" title="Listed here are all of the standard molecular identifiers which Argonaut supports."></span>
				...
				<div class="col-md-12" style="margin-bottom:40px">
					<div class="panel">
						<div class="panel-body" id="uploadPanelBody">
							...
							<div class="row">
							    <div class="col-xs-5">
    								<label class=" control-label" style="padding-right:1%">Select Statistical Test</label><span class="glyph-icon tooltip-button icon-question-circle" style="text-align:right; color:bg-gradient-8;width: 60px" data-placement="right" title="Select a method for the hypothesis testing of this uploaded dataset. Uploads into the same branch should all use the same test."></span>
    								<select class="form-control" ng-model="significanceTest" ng-options="x as x.test for x in significanceTests" style="margin-bottom:10px">
    									<option value="" ng-if="false"></option>
    								</select>
    								<div id="totalContainer" style="text-align:center" ng-hide="significanceTest.value!='STUDENT'">
    									<p style="margin-top:5px"><em>Student's t-test</em> tests the hypothesis that two populations have equal means <b>assuming equal variance</b>.</p>
    								</div>
    								<div id="totalContainer" style="text-align:center" ng-hide="significanceTest.value!='WELCH'">
    									<p style="margin-top:5px"><em>Welch's t-test</em> tests the hypothesis that two populations have equal means <b>assuming unequal variance</b>.</p>
    								</div>
    							</div>
							</div>
						</div>
